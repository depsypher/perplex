...
extern void sub__sndraw(double left,double right,int32 passed);
...
extern uint32 func__sndraw(uint8* data,uint32 bytes);
extern uint32 func__sndopen(qbs* filename,qbs* requirements,int32 passed);
extern double func__sndlen(uint32 handle);
extern void sub__sndlimit(uint32 handle,double limit);
extern void sub__sndstop(uint32 handle);
extern void sub__sndsetpos(uint32 handle,double sec);
extern double func__sndgetpos(uint32 handle);
extern void sub__sndbal(uint32 handle,double x,double y,double z,int32 passed);
extern void sub__sndplay(uint32 handle);
extern void sub__sndloop(uint32 handle);
extern uint32 func__sndcopy(uint32 handle);
extern void sub__sndvol(uint32 handle,float volume);
extern void sub__sndpause(uint32 handle);
extern int32 func__sndpaused(uint32 handle);
extern int32 func__sndplaying(uint32 handle);
extern void sub__sndclose(uint32 handle);
extern void sub__sndplayfile(qbs *filename,int32 sync,double volume,int32 passed);
extern void sub__sndplaycopy(uint32 handle,double volume,int32 passed);
...
extern int32 func__loadfont(qbs *filename,double size,qbs *requirements,int32 passed);
...
extern int32 print_using_float(qbs* format, double value, int32 start, qbs *output);
...
void sub_clear(int32 stack,int32 passed){
...
if (stop_program){exit_ok|=2; return NULL;}//close thread #2
}
return NULL;
}
...
/*
typedef int32 functype(int32 a,int32 b);
functype *myfunc=NULL;
int32 dummyfunc(float a,float b){
return 1;
}
*/
